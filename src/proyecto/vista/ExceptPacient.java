 ...
 * @author Jou
 */
public class ExceptPacient extends javax.swing.JDialog
{
     ...
     * @param modal
     */
    public ExceptPacient(java.awt.Frame parent, boolean modal, ListaSL lsl)
    {
        super(parent, modal);
        ExceptPacient.lsl = lsl;
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("<html>Excepcion de<br>pacientes</html>");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ExceptPacient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(()
                ->
        {
            ExceptPacient dialog = new ExceptPacient(new javax.swing.JFrame(), true, lsl);
